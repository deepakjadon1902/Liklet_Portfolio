      ...
      <section className="bg-card section-padding">
        <div className="container-max max-w-4xl">
          <div className="prose prose-lg max-w-none space-y-8 text-muted-foreground">
            ...
            <div><h2 className="font-display text-2xl font-bold text-foreground">5. Your Rights</h2><p>You have the right to access, correct, or delete your personal data. Contact us at support@liklet.com to exercise these rights.</p></div>
            ...
            <div><h2 className="font-display text-2xl font-bold text-foreground">7. Contact</h2><p>For privacy inquiries, contact our Data Protection Officer at support@liklet.com.</p></div>
          </div>
        </div>
      </section>
    </div>
