...
const serviceNavMeta: Record<
  string,
  { logoUrl: string; bg: string; letter: string }
> = {
  "/it-services": {
                          ...
                          >
                            ...
                            >
                              <motion.div
                                ...
                                className="w-8 h-8 rounded-lg flex items-center justify-center overflow-hidden border border-border shadow-sm"
                                style={{ backgroundColor: serviceNavMeta[child.path]?.bg || "rgba(0,0,0,0.04)" }}
                              >
                                <img
                                  src={serviceNavMeta[child.path]?.logoUrl}
                                  alt={`${child.name} logo`}
                                ...
                                <span className="hidden text-white text-xs font-bold">
                                  {serviceNavMeta[child.path]?.letter || child.name.charAt(0)}
                                </span>
                              </motion.div>
